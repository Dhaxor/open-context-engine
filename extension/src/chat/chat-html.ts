...
<div id="tourChromeBar" class="tour-chrome-bar" hidden aria-hidden="true">
  <span class="tour-chrome-label">Chat toolbar</span>
  <span class="tour-chrome-hint muted">same row as <b>CHAT</b> above this panel</span>
  <div class="tour-chrome-actions">
    <span class="tour-chrome-btn" id="tourBarIndex" title="Index workspace">${icon('sync')}</span>
    <span class="tour-chrome-btn" id="tourBarFolder" title="Select folder to index">${icon('folder')}</span>
    <span class="tour-chrome-btn" id="tourBarHealth" title="Index health">${icon('pulse')}</span>
    <span class="tour-chrome-btn" id="tourBarDebug" title="Debug retrieval">${icon('search')}</span>
    <span class="tour-chrome-btn" id="tourBarSettings" title="Open settings">${icon('gear')}</span>
  </div>
</div>
<header id="hdr">
  ...
  <button id="settingsBtn" class="iconbtn" title="Model &amp; API keys">${icon('key')}</button>
</header>

<section id="settingsPanel" class="panel" hidden>
  <div class="panel-hdr">${icon('key')}<span>Model &amp; API keys</span><div class="spacer"></div><button id="settingsClose" class="iconbtn" title="Close">${icon('close')}</button></div>
  <div class="panel-body">
    ${modelKeysFormHtml()}
    <button type="button" id="openFullSettings" class="full-settings-link">${icon('open')} Open full settings</button>
  </div>
</section>
